...
inline size_t stdmath_bool2x3_rows_get(const stdmath_bool2x3* m) {
	return stdmath_bool2x3_rows(m);
}
size_t stdmath_bool2x3_columns(const stdmath_bool2x3* m);
inline size_t stdmath_bool2x3_columns_get(const stdmath_bool2x3* m) {
...
stdmath::bool2x3 c(stdmath_bool2x3 c) {
	return (stdmath::bool2x3&)c;
}
stdmath_bool2x3 c(stdmath::bool2x3 c) {
