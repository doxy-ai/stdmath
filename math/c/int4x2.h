...
inline size_t stdmath_int4x2_rows_get(const stdmath_int4x2* m) {
	return stdmath_int4x2_rows(m);
}
size_t stdmath_int4x2_columns(const stdmath_int4x2* m);
inline size_t stdmath_int4x2_columns_get(const stdmath_int4x2* m) {
...
stdmath::int4x2 c(stdmath_int4x2 c) {
	return (stdmath::int4x2&)c;
}
stdmath_int4x2 c(stdmath::int4x2 c) {
