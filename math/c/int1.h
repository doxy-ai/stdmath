...
inline static stdmath_int1 stdmath_int1_x_get(stdmath_int1* p) { return stdmath_int1_x(*p); }
inline static stdmath_int1 stdmath_int1_x_set(stdmath_int1* p, stdmath_int1 value) { p->x = value.x; return *p; }
