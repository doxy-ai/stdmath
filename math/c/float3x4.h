...
inline size_t stdmath_float3x4_rows_get(const stdmath_float3x4* m) {
	return stdmath_float3x4_rows(m);
}
size_t stdmath_float3x4_columns(const stdmath_float3x4* m);
inline size_t stdmath_float3x4_columns_get(const stdmath_float3x4* m) {
...
stdmath::float3x4 c(stdmath_float3x4 c) {
	return (stdmath::float3x4&)c;
}
stdmath_float3x4 c(stdmath::float3x4 c) {
