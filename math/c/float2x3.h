...
inline size_t stdmath_float2x3_rows_get(const stdmath_float2x3* m) {
	return stdmath_float2x3_rows(m);
}
size_t stdmath_float2x3_columns(const stdmath_float2x3* m);
inline size_t stdmath_float2x3_columns_get(const stdmath_float2x3* m) {
...
stdmath::float2x3 c(stdmath_float2x3 c) {
	return (stdmath::float2x3&)c;
}
stdmath_float2x3 c(stdmath::float2x3 c) {
