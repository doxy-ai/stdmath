...
%extend stdmath_bool1 {
	...
	bool1 _equal_to(stdmath_bool1 o) {
		return stdmath_bool1_equal_to(*self, o);
	}
	bool1 _not_equal_to(stdmath_bool1 o) {
		return stdmath_bool1_not_equal_to(*self, o);
	}
	bool1 _less_than(stdmath_bool1 o) {
		return stdmath_bool1_less_than(*self, o);
	}
	bool1 _less_than_or_equal_to(stdmath_bool1 o) {
		return stdmath_bool1_less_than_or_equal_to(*self, o);
	}
	bool1 _greater_than(stdmath_bool1 o) {
	...
	stdmath_bool1 _lerp(stdmath_bool1 o, bool t) {
	...
	bool1 _approximately_equal(stdmath_bool1 o) {
		return stdmath_bool1_approximately_equal()
	}
