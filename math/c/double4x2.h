...
inline size_t stdmath_double4x2_rows_get(const stdmath_double4x2* m) {
	return stdmath_double4x2_rows(m);
}
size_t stdmath_double4x2_columns(const stdmath_double4x2* m);
inline size_t stdmath_double4x2_columns_get(const stdmath_double4x2* m) {
...
stdmath::double4x2 c(stdmath_double4x2 c) {
	return (stdmath::double4x2&)c;
}
stdmath_double4x2 c(stdmath::double4x2 c) {
