...
inline size_t stdmath_double4x4_rows_get(const stdmath_double4x4* m) {
	return stdmath_double4x4_rows(m);
}
size_t stdmath_double4x4_columns(const stdmath_double4x4* m);
inline size_t stdmath_double4x4_columns_get(const stdmath_double4x4* m) {
...
stdmath::double4x4 c(stdmath_double4x4 c) {
	return (stdmath::double4x4&)c;
}
stdmath_double4x4 c(stdmath::double4x4 c) {
