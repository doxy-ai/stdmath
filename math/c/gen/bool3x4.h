...
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_identity_scaled(bool scale);
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_identity();
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_fill(bool value);

STDMATH_EXPORT size_t stdmath_bool3x4_rows(const stdmath_bool3x4* m);
STDMATH_EXPORT inline size_t stdmath_bool3x4_rows_get(const stdmath_bool3x4* m) {
	return stdmath_bool3x4_rows(m);
}
STDMATH_EXPORT size_t stdmath_bool3x4_columns(const stdmath_bool3x4* m);
STDMATH_EXPORT inline size_t stdmath_bool3x4_columns_get(const stdmath_bool3x4* m) {
	return stdmath_bool3x4_columns(m);
}
STDMATH_EXPORT size_t stdmath_bool3x4_size(const stdmath_bool3x4* m);

STDMATH_EXPORT bool stdmath_bool3x4_get_element(const stdmath_bool3x4* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_set_element(const stdmath_bool3x4* m, size_t x, size_t y, bool value);

STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_add(const stdmath_bool3x4* a, const stdmath_bool3x4* b);
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_subtract(const stdmath_bool3x4* a, const stdmath_bool3x4* b);
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_negate(const stdmath_bool3x4* m);
STDMATH_EXPORT stdmath_bool4x3 stdmath_bool3x4_transpose(const stdmath_bool3x4* m);

STDMATH_EXPORT stdmath_bool3x2 stdmath_bool3x4_multiply2(const stdmath_bool3x4* a, const stdmath_bool4x2* b);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x4_multiply3(const stdmath_bool3x4* a, const stdmath_bool4x3* b);
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x4_multiply4(const stdmath_bool3x4* a, const stdmath_bool4x4* b);
STDMATH_EXPORT stdmath_bool4 stdmath_bool3x4_multiply(const stdmath_bool3x4* m, stdmath_bool4 v);
...
inline stdmath::bool3x4 c(stdmath_bool3x4 c) {
	return (stdmath::bool3x4&)c;
}
inline stdmath_bool3x4 c(stdmath::bool3x4 c) {
...
bool stdmath_bool3x4_equal_to(const stdmath_bool3x4* a, const stdmath_bool3x4* b) {
	return c(*a) == c(*b);
}
