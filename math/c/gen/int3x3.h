...
STDMATH_EXPORT bool stdmath_int3x3_equal_to(const stdmath_int3x3* a, const stdmath_int3x3* b);
STDMATH_EXPORT bool stdmath_int3x3_not_equal_to(const stdmath_int3x3* a, const stdmath_int3x3* b);
STDMATH_EXPORT bool stdmath_int3x3_approximately_equal(const stdmath_int3x3* a, const stdmath_int3x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_int3x3_to_string(const stdmath_int3x3* m);
...
bool stdmath_int3x3_equal_to(const stdmath_int3x3* a, const stdmath_int3x3* b) {
	return c(*a) == c(*b);
}
bool stdmath_int3x3_not_equal_to(const stdmath_int3x3* a, const stdmath_int3x3* b) {
	return c(*a) != c(*b);
}
bool stdmath_int3x3_approximately_equal(const stdmath_int3x3* a, const stdmath_int3x3* b) {
...
stdmath_string_view stdmath_int3x3_to_string(const stdmath_int3x3* m) {
