...
STDMATH_EXPORT bool stdmath_uint3x3_approximately_equal(stdmath_uint3x3* a, stdmath_uint3x3* b);
...
bool stdmath_uint3x3_approximately_equal(stdmath_uint3x3* a, stdmath_uint3x3* b) {
