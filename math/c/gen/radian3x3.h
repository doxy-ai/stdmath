...
STDMATH_EXPORT bool stdmath_radian3x3_approximately_equal(const stdmath_radian3x3* a, const stdmath_radian3x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_radian3x3_to_string(const stdmath_radian3x3* m);
...
bool stdmath_radian3x3_approximately_equal(const stdmath_radian3x3* a, const stdmath_radian3x3* b) {
...
stdmath_string_view stdmath_radian3x3_to_string(const stdmath_radian3x3* m) {
