...
%extend stdmath_uint3x2 {
	...
	stdmath_uint3x2(const stdmath_uint3x2& o) {
		stdmath_uint3x2 *m;
		m = (stdmath_uint3x2 *) malloc(sizeof(stdmath_uint3x2));
		memcpy(m, &o, sizeof(o));
		return m;
	}
	...
	bool _equal_to(stdmath_uint3x2* o) {
		return stdmath_uint3x2_equal_to(self, o);
	}
	bool _not_equal_to(stdmath_uint3x2* o) {
		return stdmath_uint3x2_not_equal_to(self, o);
	}
	bool _approximately_equal(stdmath_uint3x2* o) {
		return stdmath_uint3x2_approximately_equal(self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_uint3x2_to_string(self);
		*str = out.data;
		*len = out.len;
	}
