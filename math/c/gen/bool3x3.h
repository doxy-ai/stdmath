...
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_identity_scaled(bool scale);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_identity();
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_fill(bool value);

STDMATH_EXPORT size_t stdmath_bool3x3_rows(const stdmath_bool3x3* m);
STDMATH_EXPORT inline size_t stdmath_bool3x3_rows_get(const stdmath_bool3x3* m) {
	return stdmath_bool3x3_rows(m);
}
STDMATH_EXPORT size_t stdmath_bool3x3_columns(const stdmath_bool3x3* m);
STDMATH_EXPORT inline size_t stdmath_bool3x3_columns_get(const stdmath_bool3x3* m) {
	return stdmath_bool3x3_columns(m);
}
STDMATH_EXPORT size_t stdmath_bool3x3_size(const stdmath_bool3x3* m);

STDMATH_EXPORT bool stdmath_bool3x3_get_element(const stdmath_bool3x3* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_set_element(const stdmath_bool3x3* m, size_t x, size_t y, bool value);

STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_add(const stdmath_bool3x3* a, const stdmath_bool3x3* b);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_subtract(const stdmath_bool3x3* a, const stdmath_bool3x3* b);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_negate(const stdmath_bool3x3* m);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_transpose(const stdmath_bool3x3* m);

STDMATH_EXPORT stdmath_bool3x2 stdmath_bool3x3_multiply2(const stdmath_bool3x3* a, const stdmath_bool3x2* b);
STDMATH_EXPORT stdmath_bool3x3 stdmath_bool3x3_multiply3(const stdmath_bool3x3* a, const stdmath_bool3x3* b);
STDMATH_EXPORT stdmath_bool3x4 stdmath_bool3x3_multiply4(const stdmath_bool3x3* a, const stdmath_bool3x4* b);
STDMATH_EXPORT stdmath_bool3 stdmath_bool3x3_multiply(const stdmath_bool3x3* m, stdmath_bool3 v);

STDMATH_EXPORT bool stdmath_bool3x3_equal_to(const stdmath_bool3x3* a, const stdmath_bool3x3* b);
STDMATH_EXPORT bool stdmath_bool3x3_not_equal_to(const stdmath_bool3x3* a, const stdmath_bool3x3* b);
STDMATH_EXPORT bool stdmath_bool3x3_approximately_equal(const stdmath_bool3x3* a, const stdmath_bool3x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_bool3x3_to_string(const stdmath_bool3x3* m);
...
inline stdmath::bool3x3 c(stdmath_bool3x3 c) {
	return (stdmath::bool3x3&)c;
}
inline stdmath_bool3x3 c(stdmath::bool3x3 c) {
...
bool stdmath_bool3x3_equal_to(const stdmath_bool3x3* a, const stdmath_bool3x3* b) {
	return c(*a) == c(*b);
}
bool stdmath_bool3x3_not_equal_to(const stdmath_bool3x3* a, const stdmath_bool3x3* b) {
	return c(*a) != c(*b);
}
bool stdmath_bool3x3_approximately_equal(const stdmath_bool3x3* a, const stdmath_bool3x3* b) {
...
stdmath_string_view stdmath_bool3x3_to_string(const stdmath_bool3x3* m) {
