...
STDMATH_EXPORT bool stdmath_bool3x3_approximately_equal(stdmath_bool3x3* a, stdmath_bool3x3* b);
...
bool stdmath_bool3x3_approximately_equal(stdmath_bool3x3* a, stdmath_bool3x3* b) {
