...
STDMATH_EXPORT bool stdmath_byte4x4_approximately_equal(const stdmath_byte4x4* a, const stdmath_byte4x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_byte4x4_to_string(const stdmath_byte4x4* m);
...
bool stdmath_byte4x4_approximately_equal(const stdmath_byte4x4* a, const stdmath_byte4x4* b) {
...
stdmath_string_view stdmath_byte4x4_to_string(const stdmath_byte4x4* m) {
