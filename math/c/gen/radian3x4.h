...
STDMATH_EXPORT bool stdmath_radian3x4_approximately_equal(const stdmath_radian3x4* a, const stdmath_radian3x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_radian3x4_to_string(const stdmath_radian3x4* m);
...
bool stdmath_radian3x4_approximately_equal(const stdmath_radian3x4* a, const stdmath_radian3x4* b) {
...
stdmath_string_view stdmath_radian3x4_to_string(const stdmath_radian3x4* m) {
