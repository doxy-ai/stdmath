...
STDMATH_EXPORT bool stdmath_double2x3_approximately_equal(stdmath_double2x3* a, stdmath_double2x3* b);
...
bool stdmath_double2x3_approximately_equal(stdmath_double2x3* a, stdmath_double2x3* b) {
