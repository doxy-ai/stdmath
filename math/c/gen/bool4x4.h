...
STDMATH_EXPORT bool stdmath_bool4x4_approximately_equal(const stdmath_bool4x4* a, const stdmath_bool4x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_bool4x4_to_string(const stdmath_bool4x4* m);
...
bool stdmath_bool4x4_approximately_equal(const stdmath_bool4x4* a, const stdmath_bool4x4* b) {
...
stdmath_string_view stdmath_bool4x4_to_string(const stdmath_bool4x4* m) {
