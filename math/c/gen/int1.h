...
STDMATH_EXPORT stdmath_int1 stdmath_int1_broadcast(int32_t all);

STDMATH_EXPORT stdmath_int1 stdmath_int1_add(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_subtract(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_negate(stdmath_int1 v);
STDMATH_EXPORT stdmath_int1 stdmath_int1_multiply(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_divide(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_scale(stdmath_int1 v, int32_t s);

#if false
STDMATH_EXPORT stdmath_int1 stdmath_int1_modulus(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_logical_not(stdmath_int1 v);
STDMATH_EXPORT stdmath_int1 stdmath_int1_bitwise_not(stdmath_int1 v);
STDMATH_EXPORT stdmath_int1 stdmath_int1_logical_and(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_bitwise_and(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_logical_or(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_bitwise_or(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_bitwise_xor(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_shift_left(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_shift_right(stdmath_int1 a, stdmath_int1 b);
#endif

STDMATH_EXPORT stdmath_bool1 stdmath_int1_equal_to(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_bool1 stdmath_int1_not_equal_to(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_bool1 stdmath_int1_less_than(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_bool1 stdmath_int1_less_than_or_equal_to(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_bool1 stdmath_int1_greater_than(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_bool1 stdmath_int1_greater_than_or_equal_to(stdmath_int1 a, stdmath_int1 b);

STDMATH_EXPORT int32_t stdmath_int1_length_squared(stdmath_int1 v);
STDMATH_EXPORT int32_t stdmath_int1_length(stdmath_int1 v);
STDMATH_EXPORT int32_t stdmath_int1_dot(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT int32_t stdmath_int1_min_element(stdmath_int1 v);
STDMATH_EXPORT int32_t stdmath_int1_max_element(stdmath_int1 v);

// STDMATH_EXPORT stdmath_int1 stdmath_int1_elementwise_transform(stdmath_int1 v, int32_t(*func)(int32_t));
// STDMATH_EXPORT int32_t stdmath_int1_reduce_elements(stdmath_int1 v, int32_t initial_value, int32_t(*reducer)(stdmath_int1, stdmath_int1));

#if 1 == 3
STDMATH_EXPORT stdmath_int3 stdmath_int3_cross(stdmath_int3 a, stdmath_int3 b);
#endif

STDMATH_EXPORT stdmath_int1 stdmath_int1_min(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_max(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_int1 stdmath_int1_normalize(stdmath_int1 v);
STDMATH_EXPORT stdmath_int1 stdmath_int1_lerp(stdmath_int1 a, stdmath_int1 b, float t);
STDMATH_EXPORT stdmath_int1 stdmath_int1_clamp(stdmath_int1 a, stdmath_int1 min, stdmath_int1 max);
STDMATH_EXPORT stdmath_int1 stdmath_int1_reflect(stdmath_int1 a, stdmath_int1 b);
STDMATH_EXPORT stdmath_bool1 stdmath_int1_approximately_equal(stdmath_int1 a, stdmath_int1 b);
...
STDMATH_EXPORT stdmath_string_view stdmath_int1_to_string(stdmath_int1 v);

#ifndef STDMATH_NO_SWIZZLES
STDMATH_EXPORT STDMATH_INLINE stdmath_int1 stdmath_int1_x(stdmath_int1 v) { return {v.x}; }
STDMATH_EXPORT STDMATH_INLINE stdmath_int1 stdmath_int1_x_get(stdmath_int1* p) { return stdmath_int1_x(*p); }
STDMATH_EXPORT STDMATH_INLINE stdmath_int1 stdmath_int1_x_set(stdmath_int1* p, stdmath_int1 value) { p->x = value.x; return *p; }
...
inline stdmath::int1 c(stdmath_int1 c) {
	return (stdmath::int1&)c;
}
inline stdmath_int1 c(stdmath::int1 c) {
...
stdmath_string_view stdmath_int1_to_string(stdmath_int1 v) {
