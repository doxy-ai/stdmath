...
%extend stdmath_bool4x4 {
	...
	bool _equal_to(stdmath_bool4x4* o) {
		return stdmath_bool4x4_equal_to(self, o);
	}
	bool _not_equal_to(stdmath_bool4x4* o) {
		return stdmath_bool4x4_not_equal_to(self, o);
	}
	bool _approximately_equal(stdmath_bool4x4* o) {
		return stdmath_bool4x4_approximately_equal(self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_bool4x4_to_string(self);
		*str = out.data;
		*len = out.len;
	}
