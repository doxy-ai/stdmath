...
STDMATH_EXPORT bool stdmath_byte3x3_approximately_equal(stdmath_byte3x3* a, stdmath_byte3x3* b);
...
bool stdmath_byte3x3_approximately_equal(stdmath_byte3x3* a, stdmath_byte3x3* b) {
