...
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_identity_scaled(uint8_t scale);
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_identity();
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_fill(uint8_t value);

STDMATH_EXPORT size_t stdmath_byte3x3_rows(const stdmath_byte3x3* m);
STDMATH_EXPORT inline size_t stdmath_byte3x3_rows_get(const stdmath_byte3x3* m) {
	return stdmath_byte3x3_rows(m);
}
STDMATH_EXPORT size_t stdmath_byte3x3_columns(const stdmath_byte3x3* m);
STDMATH_EXPORT inline size_t stdmath_byte3x3_columns_get(const stdmath_byte3x3* m) {
	return stdmath_byte3x3_columns(m);
}
STDMATH_EXPORT size_t stdmath_byte3x3_size(const stdmath_byte3x3* m);

STDMATH_EXPORT uint8_t stdmath_byte3x3_get_element(const stdmath_byte3x3* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_set_element(const stdmath_byte3x3* m, size_t x, size_t y, uint8_t value);

STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_add(const stdmath_byte3x3* a, const stdmath_byte3x3* b);
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_subtract(const stdmath_byte3x3* a, const stdmath_byte3x3* b);
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_negate(const stdmath_byte3x3* m);
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_transpose(const stdmath_byte3x3* m);

STDMATH_EXPORT stdmath_byte3x2 stdmath_byte3x3_multiply2(const stdmath_byte3x3* a, const stdmath_byte3x2* b);
STDMATH_EXPORT stdmath_byte3x3 stdmath_byte3x3_multiply3(const stdmath_byte3x3* a, const stdmath_byte3x3* b);
STDMATH_EXPORT stdmath_byte3x4 stdmath_byte3x3_multiply4(const stdmath_byte3x3* a, const stdmath_byte3x4* b);
STDMATH_EXPORT stdmath_byte3 stdmath_byte3x3_multiply(const stdmath_byte3x3* m, stdmath_byte3 v);

STDMATH_EXPORT bool stdmath_byte3x3_equal_to(const stdmath_byte3x3* a, const stdmath_byte3x3* b);
STDMATH_EXPORT bool stdmath_byte3x3_not_equal_to(const stdmath_byte3x3* a, const stdmath_byte3x3* b);
STDMATH_EXPORT bool stdmath_byte3x3_approximately_equal(const stdmath_byte3x3* a, const stdmath_byte3x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_byte3x3_to_string(const stdmath_byte3x3* m);
...
inline stdmath::byte3x3 c(stdmath_byte3x3 c) {
	return (stdmath::byte3x3&)c;
}
inline stdmath_byte3x3 c(stdmath::byte3x3 c) {
...
bool stdmath_byte3x3_equal_to(const stdmath_byte3x3* a, const stdmath_byte3x3* b) {
	return c(*a) == c(*b);
}
bool stdmath_byte3x3_not_equal_to(const stdmath_byte3x3* a, const stdmath_byte3x3* b) {
	return c(*a) != c(*b);
}
bool stdmath_byte3x3_approximately_equal(const stdmath_byte3x3* a, const stdmath_byte3x3* b) {
...
stdmath_string_view stdmath_byte3x3_to_string(const stdmath_byte3x3* m) {
