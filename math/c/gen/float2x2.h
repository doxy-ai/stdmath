...
STDMATH_EXPORT bool stdmath_float2x2_approximately_equal(stdmath_float2x2* a, stdmath_float2x2* b);
...
bool stdmath_float2x2_approximately_equal(stdmath_float2x2* a, stdmath_float2x2* b) {
