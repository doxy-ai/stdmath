...
STDMATH_EXPORT bool stdmath_int2x2_approximately_equal(stdmath_int2x2* a, stdmath_int2x2* b);
...
bool stdmath_int2x2_approximately_equal(stdmath_int2x2* a, stdmath_int2x2* b) {
