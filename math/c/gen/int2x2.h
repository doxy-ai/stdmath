...
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_identity_scaled(int32_t scale);
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_identity();
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_fill(int32_t value);

STDMATH_EXPORT size_t stdmath_int2x2_rows(const stdmath_int2x2* m);
STDMATH_EXPORT inline size_t stdmath_int2x2_rows_get(const stdmath_int2x2* m) {
	return stdmath_int2x2_rows(m);
}
STDMATH_EXPORT size_t stdmath_int2x2_columns(const stdmath_int2x2* m);
STDMATH_EXPORT inline size_t stdmath_int2x2_columns_get(const stdmath_int2x2* m) {
	return stdmath_int2x2_columns(m);
}
STDMATH_EXPORT size_t stdmath_int2x2_size(const stdmath_int2x2* m);

STDMATH_EXPORT int32_t stdmath_int2x2_get_element(const stdmath_int2x2* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_set_element(const stdmath_int2x2* m, size_t x, size_t y, int32_t value);

STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_add(const stdmath_int2x2* a, const stdmath_int2x2* b);
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_subtract(const stdmath_int2x2* a, const stdmath_int2x2* b);
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_negate(const stdmath_int2x2* m);
STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_transpose(const stdmath_int2x2* m);

STDMATH_EXPORT stdmath_int2x2 stdmath_int2x2_multiply2(const stdmath_int2x2* a, const stdmath_int2x2* b);
STDMATH_EXPORT stdmath_int2x3 stdmath_int2x2_multiply3(const stdmath_int2x2* a, const stdmath_int2x3* b);
STDMATH_EXPORT stdmath_int2x4 stdmath_int2x2_multiply4(const stdmath_int2x2* a, const stdmath_int2x4* b);
STDMATH_EXPORT stdmath_int2 stdmath_int2x2_multiply(const stdmath_int2x2* m, stdmath_int2 v);

STDMATH_EXPORT bool stdmath_int2x2_equal_to(const stdmath_int2x2* a, const stdmath_int2x2* b);
STDMATH_EXPORT bool stdmath_int2x2_not_equal_to(const stdmath_int2x2* a, const stdmath_int2x2* b);
STDMATH_EXPORT bool stdmath_int2x2_approximately_equal(const stdmath_int2x2* a, const stdmath_int2x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_int2x2_to_string(const stdmath_int2x2* m);
...
inline stdmath::int2x2 c(stdmath_int2x2 c) {
	return (stdmath::int2x2&)c;
}
inline stdmath_int2x2 c(stdmath::int2x2 c) {
...
bool stdmath_int2x2_equal_to(const stdmath_int2x2* a, const stdmath_int2x2* b) {
	return c(*a) == c(*b);
}
bool stdmath_int2x2_not_equal_to(const stdmath_int2x2* a, const stdmath_int2x2* b) {
	return c(*a) != c(*b);
}
bool stdmath_int2x2_approximately_equal(const stdmath_int2x2* a, const stdmath_int2x2* b) {
...
stdmath_string_view stdmath_int2x2_to_string(const stdmath_int2x2* m) {
