...
STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_identity_scaled(double scale);
STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_identity();
STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_fill(double value);

STDMATH_EXPORT size_t stdmath_double3x2_rows(const stdmath_double3x2* m);
STDMATH_EXPORT inline size_t stdmath_double3x2_rows_get(const stdmath_double3x2* m) {
	return stdmath_double3x2_rows(m);
}
STDMATH_EXPORT size_t stdmath_double3x2_columns(const stdmath_double3x2* m);
STDMATH_EXPORT inline size_t stdmath_double3x2_columns_get(const stdmath_double3x2* m) {
	return stdmath_double3x2_columns(m);
}
STDMATH_EXPORT size_t stdmath_double3x2_size(const stdmath_double3x2* m);

STDMATH_EXPORT double stdmath_double3x2_get_element(const stdmath_double3x2* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_set_element(const stdmath_double3x2* m, size_t x, size_t y, double value);

STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_add(const stdmath_double3x2* a, const stdmath_double3x2* b);
STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_subtract(const stdmath_double3x2* a, const stdmath_double3x2* b);
STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_negate(const stdmath_double3x2* m);
STDMATH_EXPORT stdmath_double2x3 stdmath_double3x2_transpose(const stdmath_double3x2* m);

STDMATH_EXPORT stdmath_double3x2 stdmath_double3x2_multiply2(const stdmath_double3x2* a, const stdmath_double2x2* b);
STDMATH_EXPORT stdmath_double3x3 stdmath_double3x2_multiply3(const stdmath_double3x2* a, const stdmath_double2x3* b);
STDMATH_EXPORT stdmath_double3x4 stdmath_double3x2_multiply4(const stdmath_double3x2* a, const stdmath_double2x4* b);
STDMATH_EXPORT stdmath_double2 stdmath_double3x2_multiply(const stdmath_double3x2* m, stdmath_double2 v);

STDMATH_EXPORT bool stdmath_double3x2_equal_to(const stdmath_double3x2* a, const stdmath_double3x2* b);
STDMATH_EXPORT bool stdmath_double3x2_not_equal_to(const stdmath_double3x2* a, const stdmath_double3x2* b);
STDMATH_EXPORT bool stdmath_double3x2_approximately_equal(const stdmath_double3x2* a, const stdmath_double3x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_double3x2_to_string(const stdmath_double3x2* m);
...
inline stdmath::double3x2 c(stdmath_double3x2 c) {
	return (stdmath::double3x2&)c;
}
inline stdmath_double3x2 c(stdmath::double3x2 c) {
...
bool stdmath_double3x2_equal_to(const stdmath_double3x2* a, const stdmath_double3x2* b) {
	return c(*a) == c(*b);
}
bool stdmath_double3x2_not_equal_to(const stdmath_double3x2* a, const stdmath_double3x2* b) {
	return c(*a) != c(*b);
}
bool stdmath_double3x2_approximately_equal(const stdmath_double3x2* a, const stdmath_double3x2* b) {
...
stdmath_string_view stdmath_double3x2_to_string(const stdmath_double3x2* m) {
