...
STDMATH_EXPORT bool stdmath_int3x4_approximately_equal(stdmath_int3x4* a, stdmath_int3x4* b);
...
bool stdmath_int3x4_approximately_equal(stdmath_int3x4* a, stdmath_int3x4* b) {
