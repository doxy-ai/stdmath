...
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_identity_scaled(int32_t scale);
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_identity();
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_fill(int32_t value);

STDMATH_EXPORT size_t stdmath_int3x4_rows(const stdmath_int3x4* m);
STDMATH_EXPORT inline size_t stdmath_int3x4_rows_get(const stdmath_int3x4* m) {
	return stdmath_int3x4_rows(m);
}
STDMATH_EXPORT size_t stdmath_int3x4_columns(const stdmath_int3x4* m);
STDMATH_EXPORT inline size_t stdmath_int3x4_columns_get(const stdmath_int3x4* m) {
	return stdmath_int3x4_columns(m);
}
STDMATH_EXPORT size_t stdmath_int3x4_size(const stdmath_int3x4* m);

STDMATH_EXPORT int32_t stdmath_int3x4_get_element(const stdmath_int3x4* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_set_element(const stdmath_int3x4* m, size_t x, size_t y, int32_t value);

STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_add(const stdmath_int3x4* a, const stdmath_int3x4* b);
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_subtract(const stdmath_int3x4* a, const stdmath_int3x4* b);
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_negate(const stdmath_int3x4* m);
STDMATH_EXPORT stdmath_int4x3 stdmath_int3x4_transpose(const stdmath_int3x4* m);

STDMATH_EXPORT stdmath_int3x2 stdmath_int3x4_multiply2(const stdmath_int3x4* a, const stdmath_int4x2* b);
STDMATH_EXPORT stdmath_int3x3 stdmath_int3x4_multiply3(const stdmath_int3x4* a, const stdmath_int4x3* b);
STDMATH_EXPORT stdmath_int3x4 stdmath_int3x4_multiply4(const stdmath_int3x4* a, const stdmath_int4x4* b);
STDMATH_EXPORT stdmath_int4 stdmath_int3x4_multiply(const stdmath_int3x4* m, stdmath_int4 v);

STDMATH_EXPORT bool stdmath_int3x4_equal_to(const stdmath_int3x4* a, const stdmath_int3x4* b);
STDMATH_EXPORT bool stdmath_int3x4_not_equal_to(const stdmath_int3x4* a, const stdmath_int3x4* b);
STDMATH_EXPORT bool stdmath_int3x4_approximately_equal(const stdmath_int3x4* a, const stdmath_int3x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_int3x4_to_string(const stdmath_int3x4* m);
...
inline stdmath::int3x4 c(stdmath_int3x4 c) {
	return (stdmath::int3x4&)c;
}
inline stdmath_int3x4 c(stdmath::int3x4 c) {
...
bool stdmath_int3x4_equal_to(const stdmath_int3x4* a, const stdmath_int3x4* b) {
	return c(*a) == c(*b);
}
bool stdmath_int3x4_not_equal_to(const stdmath_int3x4* a, const stdmath_int3x4* b) {
	return c(*a) != c(*b);
}
bool stdmath_int3x4_approximately_equal(const stdmath_int3x4* a, const stdmath_int3x4* b) {
...
stdmath_string_view stdmath_int3x4_to_string(const stdmath_int3x4* m) {
