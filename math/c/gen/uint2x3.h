...
STDMATH_EXPORT bool stdmath_uint2x3_approximately_equal(stdmath_uint2x3* a, stdmath_uint2x3* b);
...
bool stdmath_uint2x3_approximately_equal(stdmath_uint2x3* a, stdmath_uint2x3* b) {
