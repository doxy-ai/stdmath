...
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_identity_scaled(uint32_t scale);
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_identity();
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_fill(uint32_t value);

STDMATH_EXPORT size_t stdmath_uint2x3_rows(const stdmath_uint2x3* m);
STDMATH_EXPORT inline size_t stdmath_uint2x3_rows_get(const stdmath_uint2x3* m) {
	return stdmath_uint2x3_rows(m);
}
STDMATH_EXPORT size_t stdmath_uint2x3_columns(const stdmath_uint2x3* m);
STDMATH_EXPORT inline size_t stdmath_uint2x3_columns_get(const stdmath_uint2x3* m) {
	return stdmath_uint2x3_columns(m);
}
STDMATH_EXPORT size_t stdmath_uint2x3_size(const stdmath_uint2x3* m);

STDMATH_EXPORT uint32_t stdmath_uint2x3_get_element(const stdmath_uint2x3* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_set_element(const stdmath_uint2x3* m, size_t x, size_t y, uint32_t value);

STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_add(const stdmath_uint2x3* a, const stdmath_uint2x3* b);
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_subtract(const stdmath_uint2x3* a, const stdmath_uint2x3* b);
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_negate(const stdmath_uint2x3* m);
STDMATH_EXPORT stdmath_uint3x2 stdmath_uint2x3_transpose(const stdmath_uint2x3* m);

STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x3_multiply2(const stdmath_uint2x3* a, const stdmath_uint3x2* b);
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x3_multiply3(const stdmath_uint2x3* a, const stdmath_uint3x3* b);
STDMATH_EXPORT stdmath_uint2x4 stdmath_uint2x3_multiply4(const stdmath_uint2x3* a, const stdmath_uint3x4* b);
STDMATH_EXPORT stdmath_uint3 stdmath_uint2x3_multiply(const stdmath_uint2x3* m, stdmath_uint3 v);

STDMATH_EXPORT bool stdmath_uint2x3_equal_to(const stdmath_uint2x3* a, const stdmath_uint2x3* b);
STDMATH_EXPORT bool stdmath_uint2x3_not_equal_to(const stdmath_uint2x3* a, const stdmath_uint2x3* b);
STDMATH_EXPORT bool stdmath_uint2x3_approximately_equal(const stdmath_uint2x3* a, const stdmath_uint2x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_uint2x3_to_string(const stdmath_uint2x3* m);
...
inline stdmath::uint2x3 c(stdmath_uint2x3 c) {
	return (stdmath::uint2x3&)c;
}
inline stdmath_uint2x3 c(stdmath::uint2x3 c) {
...
bool stdmath_uint2x3_equal_to(const stdmath_uint2x3* a, const stdmath_uint2x3* b) {
	return c(*a) == c(*b);
}
bool stdmath_uint2x3_not_equal_to(const stdmath_uint2x3* a, const stdmath_uint2x3* b) {
	return c(*a) != c(*b);
}
bool stdmath_uint2x3_approximately_equal(const stdmath_uint2x3* a, const stdmath_uint2x3* b) {
...
stdmath_string_view stdmath_uint2x3_to_string(const stdmath_uint2x3* m) {
