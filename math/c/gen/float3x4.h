...
STDMATH_EXPORT bool stdmath_float3x4_approximately_equal(stdmath_float3x4* a, stdmath_float3x4* b);
...
bool stdmath_float3x4_approximately_equal(stdmath_float3x4* a, stdmath_float3x4* b) {
