...
%extend stdmath_float2 {
	...
	stdmath_float2(const stdmath_float2& o) {
		stdmath_float2 *v;
		v = (stdmath_float2 *) malloc(sizeof(stdmath_float2));
		memcpy(v, &o, sizeof(o));
		return v;
	...
	stdmath_bool2 _equal_to(stdmath_float2 o) {
		return stdmath_float2_equal_to(*self, o);
	}
	stdmath_bool2 _not_equal_to(stdmath_float2 o) {
		return stdmath_float2_not_equal_to(*self, o);
	}
	stdmath_bool2 _less_than(stdmath_float2 o) {
		return stdmath_float2_less_than(*self, o);
	}
	stdmath_bool2 _less_than_or_equal_to(stdmath_float2 o) {
		return stdmath_float2_less_than_or_equal_to(*self, o);
	}
	stdmath_bool2 _greater_than(stdmath_float2 o) {
		return stdmath_float2_greater_than(*self, o);
	}
	stdmath_bool2 _greater_than_or_equal_to(stdmath_float2 o) {
	...
	float _dot(stdmath_float2 o) {
		return stdmath_float2_dot(*self, o);
	}
	float _min_element() {
	...
	stdmath_bool2 _approximately_equal(stdmath_float2 o) {
		return stdmath_float2_approximately_equal(*self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_float2_to_string(*self);
		*str = out.data;
		*len = out.len;
	}
