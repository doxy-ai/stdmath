...
STDMATH_EXPORT bool stdmath_uint3x2_equal_to(const stdmath_uint3x2* a, const stdmath_uint3x2* b);
STDMATH_EXPORT bool stdmath_uint3x2_not_equal_to(const stdmath_uint3x2* a, const stdmath_uint3x2* b);
STDMATH_EXPORT bool stdmath_uint3x2_approximately_equal(const stdmath_uint3x2* a, const stdmath_uint3x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_uint3x2_to_string(const stdmath_uint3x2* m);
...
bool stdmath_uint3x2_equal_to(const stdmath_uint3x2* a, const stdmath_uint3x2* b) {
	return c(*a) == c(*b);
}
bool stdmath_uint3x2_not_equal_to(const stdmath_uint3x2* a, const stdmath_uint3x2* b) {
	return c(*a) != c(*b);
}
bool stdmath_uint3x2_approximately_equal(const stdmath_uint3x2* a, const stdmath_uint3x2* b) {
...
stdmath_string_view stdmath_uint3x2_to_string(const stdmath_uint3x2* m) {
