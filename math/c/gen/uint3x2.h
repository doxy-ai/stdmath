...
STDMATH_EXPORT bool stdmath_uint3x2_approximately_equal(stdmath_uint3x2* a, stdmath_uint3x2* b);
...
bool stdmath_uint3x2_approximately_equal(stdmath_uint3x2* a, stdmath_uint3x2* b) {
