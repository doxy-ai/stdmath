...
STDMATH_EXPORT bool stdmath_uint3x4_approximately_equal(stdmath_uint3x4* a, stdmath_uint3x4* b);
...
bool stdmath_uint3x4_approximately_equal(stdmath_uint3x4* a, stdmath_uint3x4* b) {
