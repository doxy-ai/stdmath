...
STDMATH_EXPORT bool stdmath_uint3x4_equal_to(const stdmath_uint3x4* a, const stdmath_uint3x4* b);
STDMATH_EXPORT bool stdmath_uint3x4_not_equal_to(const stdmath_uint3x4* a, const stdmath_uint3x4* b);
STDMATH_EXPORT bool stdmath_uint3x4_approximately_equal(const stdmath_uint3x4* a, const stdmath_uint3x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_uint3x4_to_string(const stdmath_uint3x4* m);
...
bool stdmath_uint3x4_equal_to(const stdmath_uint3x4* a, const stdmath_uint3x4* b) {
	return c(*a) == c(*b);
}
bool stdmath_uint3x4_not_equal_to(const stdmath_uint3x4* a, const stdmath_uint3x4* b) {
	return c(*a) != c(*b);
}
bool stdmath_uint3x4_approximately_equal(const stdmath_uint3x4* a, const stdmath_uint3x4* b) {
...
stdmath_string_view stdmath_uint3x4_to_string(const stdmath_uint3x4* m) {
