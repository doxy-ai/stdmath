...
%extend stdmath_bool2x3 {
	...
	stdmath_bool2x3(const stdmath_bool2x3& o) {
		stdmath_bool2x3 *m;
		m = (stdmath_bool2x3 *) malloc(sizeof(stdmath_bool2x3));
		memcpy(m, &o, sizeof(o));
		return m;
	}
	...
	bool _equal_to(stdmath_bool2x3* o) {
		return stdmath_bool2x3_equal_to(self, o);
	}
	bool _not_equal_to(stdmath_bool2x3* o) {
		return stdmath_bool2x3_not_equal_to(self, o);
	}
	bool _approximately_equal(stdmath_bool2x3* o) {
		return stdmath_bool2x3_approximately_equal(self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_bool2x3_to_string(self);
		*str = out.data;
		*len = out.len;
	}
