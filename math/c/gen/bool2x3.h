...
STDMATH_EXPORT bool stdmath_bool2x3_approximately_equal(const stdmath_bool2x3* a, const stdmath_bool2x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_bool2x3_to_string(const stdmath_bool2x3* m);
...
bool stdmath_bool2x3_approximately_equal(const stdmath_bool2x3* a, const stdmath_bool2x3* b) {
...
stdmath_string_view stdmath_bool2x3_to_string(const stdmath_bool2x3* m) {
