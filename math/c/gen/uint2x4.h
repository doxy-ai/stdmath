...
STDMATH_EXPORT bool stdmath_uint2x4_approximately_equal(stdmath_uint2x4* a, stdmath_uint2x4* b);
...
bool stdmath_uint2x4_approximately_equal(stdmath_uint2x4* a, stdmath_uint2x4* b) {
