...
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_identity_scaled(float scale);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_identity();
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_fill(float value);

STDMATH_EXPORT size_t stdmath_float4x4_rows(const stdmath_float4x4* m);
STDMATH_EXPORT inline size_t stdmath_float4x4_rows_get(const stdmath_float4x4* m) {
	return stdmath_float4x4_rows(m);
}
STDMATH_EXPORT size_t stdmath_float4x4_columns(const stdmath_float4x4* m);
STDMATH_EXPORT inline size_t stdmath_float4x4_columns_get(const stdmath_float4x4* m) {
	return stdmath_float4x4_columns(m);
}
STDMATH_EXPORT size_t stdmath_float4x4_size(const stdmath_float4x4* m);

STDMATH_EXPORT float stdmath_float4x4_get_element(const stdmath_float4x4* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_set_element(const stdmath_float4x4* m, size_t x, size_t y, float value);

STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_add(const stdmath_float4x4* a, const stdmath_float4x4* b);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_subtract(const stdmath_float4x4* a, const stdmath_float4x4* b);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_negate(const stdmath_float4x4* m);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_transpose(const stdmath_float4x4* m);

STDMATH_EXPORT stdmath_float4x2 stdmath_float4x4_multiply2(const stdmath_float4x4* a, const stdmath_float4x2* b);
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x4_multiply3(const stdmath_float4x4* a, const stdmath_float4x3* b);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x4_multiply4(const stdmath_float4x4* a, const stdmath_float4x4* b);
STDMATH_EXPORT stdmath_float4 stdmath_float4x4_multiply(const stdmath_float4x4* m, stdmath_float4 v);

STDMATH_EXPORT bool stdmath_float4x4_equal_to(const stdmath_float4x4* a, const stdmath_float4x4* b);
STDMATH_EXPORT bool stdmath_float4x4_not_equal_to(const stdmath_float4x4* a, const stdmath_float4x4* b);
STDMATH_EXPORT bool stdmath_float4x4_approximately_equal(const stdmath_float4x4* a, const stdmath_float4x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_float4x4_to_string(const stdmath_float4x4* m);
...
inline stdmath::float4x4 c(stdmath_float4x4 c) {
	return (stdmath::float4x4&)c;
}
inline stdmath_float4x4 c(stdmath::float4x4 c) {
...
bool stdmath_float4x4_equal_to(const stdmath_float4x4* a, const stdmath_float4x4* b) {
	return c(*a) == c(*b);
}
bool stdmath_float4x4_not_equal_to(const stdmath_float4x4* a, const stdmath_float4x4* b) {
	return c(*a) != c(*b);
}
bool stdmath_float4x4_approximately_equal(const stdmath_float4x4* a, const stdmath_float4x4* b) {
...
stdmath_string_view stdmath_float4x4_to_string(const stdmath_float4x4* m) {
