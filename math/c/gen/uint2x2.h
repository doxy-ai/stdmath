...
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_identity_scaled(uint32_t scale);
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_identity();
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_fill(uint32_t value);

STDMATH_EXPORT size_t stdmath_uint2x2_rows(const stdmath_uint2x2* m);
STDMATH_EXPORT inline size_t stdmath_uint2x2_rows_get(const stdmath_uint2x2* m) {
	return stdmath_uint2x2_rows(m);
}
STDMATH_EXPORT size_t stdmath_uint2x2_columns(const stdmath_uint2x2* m);
STDMATH_EXPORT inline size_t stdmath_uint2x2_columns_get(const stdmath_uint2x2* m) {
	return stdmath_uint2x2_columns(m);
}
STDMATH_EXPORT size_t stdmath_uint2x2_size(const stdmath_uint2x2* m);

STDMATH_EXPORT uint32_t stdmath_uint2x2_get_element(const stdmath_uint2x2* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_set_element(const stdmath_uint2x2* m, size_t x, size_t y, uint32_t value);

STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_add(const stdmath_uint2x2* a, const stdmath_uint2x2* b);
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_subtract(const stdmath_uint2x2* a, const stdmath_uint2x2* b);
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_negate(const stdmath_uint2x2* m);
STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_transpose(const stdmath_uint2x2* m);

STDMATH_EXPORT stdmath_uint2x2 stdmath_uint2x2_multiply2(const stdmath_uint2x2* a, const stdmath_uint2x2* b);
STDMATH_EXPORT stdmath_uint2x3 stdmath_uint2x2_multiply3(const stdmath_uint2x2* a, const stdmath_uint2x3* b);
...
STDMATH_EXPORT bool stdmath_uint2x2_approximately_equal(const stdmath_uint2x2* a, const stdmath_uint2x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_uint2x2_to_string(const stdmath_uint2x2* m);
...
inline stdmath::uint2x2 c(stdmath_uint2x2 c) {
	return (stdmath::uint2x2&)c;
}
inline stdmath_uint2x2 c(stdmath::uint2x2 c) {
...
bool stdmath_uint2x2_approximately_equal(const stdmath_uint2x2* a, const stdmath_uint2x2* b) {
...
stdmath_string_view stdmath_uint2x2_to_string(const stdmath_uint2x2* m) {
