...
STDMATH_EXPORT bool stdmath_degree2x2_approximately_equal(const stdmath_degree2x2* a, const stdmath_degree2x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_degree2x2_to_string(const stdmath_degree2x2* m);
...
bool stdmath_degree2x2_approximately_equal(const stdmath_degree2x2* a, const stdmath_degree2x2* b) {
...
stdmath_string_view stdmath_degree2x2_to_string(const stdmath_degree2x2* m) {
