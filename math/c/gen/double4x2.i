...
%extend stdmath_double4x2 {
	...
	bool _equal_to(stdmath_double4x2* o) {
		return stdmath_double4x2_equal_to(self, o);
	}
	bool _not_equal_to(stdmath_double4x2* o) {
		return stdmath_double4x2_not_equal_to(self, o);
	}
	bool _approximately_equal(stdmath_double4x2* o) {
		return stdmath_double4x2_approximately_equal(self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_double4x2_to_string(self);
		*str = out.data;
		*len = out.len;
	}
