...
STDMATH_EXPORT bool stdmath_degree2x4_approximately_equal(const stdmath_degree2x4* a, const stdmath_degree2x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_degree2x4_to_string(const stdmath_degree2x4* m);
...
bool stdmath_degree2x4_approximately_equal(const stdmath_degree2x4* a, const stdmath_degree2x4* b) {
...
stdmath_string_view stdmath_degree2x4_to_string(const stdmath_degree2x4* m) {
