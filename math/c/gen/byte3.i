...
%extend stdmath_byte3 {
	...
	stdmath_byte3(const stdmath_byte3& o) {
		stdmath_byte3 *v;
		v = (stdmath_byte3 *) malloc(sizeof(stdmath_byte3));
		memcpy(v, &o, sizeof(o));
		return v;
	...
	stdmath_bool3 _equal_to(stdmath_byte3 o) {
		return stdmath_byte3_equal_to(*self, o);
	}
	stdmath_bool3 _not_equal_to(stdmath_byte3 o) {
		return stdmath_byte3_not_equal_to(*self, o);
	}
	stdmath_bool3 _less_than(stdmath_byte3 o) {
		return stdmath_byte3_less_than(*self, o);
	}
	stdmath_bool3 _less_than_or_equal_to(stdmath_byte3 o) {
		return stdmath_byte3_less_than_or_equal_to(*self, o);
	}
	stdmath_bool3 _greater_than(stdmath_byte3 o) {
		return stdmath_byte3_greater_than(*self, o);
	}
	stdmath_bool3 _greater_than_or_equal_to(stdmath_byte3 o) {
	...
	uint8_t _dot(stdmath_byte3 o) {
		return stdmath_byte3_dot(*self, o);
	}
	...
	stdmath_byte3 _lerp(stdmath_byte3 o, float t) {
	...
	stdmath_bool3 _approximately_equal(stdmath_byte3 o) {
		return stdmath_byte3_approximately_equal(*self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_byte3_to_string(*self);
		*str = out.data;
		*len = out.len;
	}
