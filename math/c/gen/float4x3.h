...
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_identity_scaled(float scale);
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_identity();
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_fill(float value);

STDMATH_EXPORT size_t stdmath_float4x3_rows(const stdmath_float4x3* m);
STDMATH_EXPORT inline size_t stdmath_float4x3_rows_get(const stdmath_float4x3* m) {
	return stdmath_float4x3_rows(m);
}
STDMATH_EXPORT size_t stdmath_float4x3_columns(const stdmath_float4x3* m);
STDMATH_EXPORT inline size_t stdmath_float4x3_columns_get(const stdmath_float4x3* m) {
	return stdmath_float4x3_columns(m);
}
STDMATH_EXPORT size_t stdmath_float4x3_size(const stdmath_float4x3* m);

STDMATH_EXPORT float stdmath_float4x3_get_element(const stdmath_float4x3* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_set_element(const stdmath_float4x3* m, size_t x, size_t y, float value);

STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_add(const stdmath_float4x3* a, const stdmath_float4x3* b);
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_subtract(const stdmath_float4x3* a, const stdmath_float4x3* b);
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_negate(const stdmath_float4x3* m);
STDMATH_EXPORT stdmath_float3x4 stdmath_float4x3_transpose(const stdmath_float4x3* m);

STDMATH_EXPORT stdmath_float4x2 stdmath_float4x3_multiply2(const stdmath_float4x3* a, const stdmath_float3x2* b);
STDMATH_EXPORT stdmath_float4x3 stdmath_float4x3_multiply3(const stdmath_float4x3* a, const stdmath_float3x3* b);
STDMATH_EXPORT stdmath_float4x4 stdmath_float4x3_multiply4(const stdmath_float4x3* a, const stdmath_float3x4* b);
STDMATH_EXPORT stdmath_float3 stdmath_float4x3_multiply(const stdmath_float4x3* m, stdmath_float3 v);

STDMATH_EXPORT bool stdmath_float4x3_equal_to(const stdmath_float4x3* a, const stdmath_float4x3* b);
STDMATH_EXPORT bool stdmath_float4x3_not_equal_to(const stdmath_float4x3* a, const stdmath_float4x3* b);
STDMATH_EXPORT bool stdmath_float4x3_approximately_equal(const stdmath_float4x3* a, const stdmath_float4x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_float4x3_to_string(const stdmath_float4x3* m);
...
inline stdmath::float4x3 c(stdmath_float4x3 c) {
	return (stdmath::float4x3&)c;
}
inline stdmath_float4x3 c(stdmath::float4x3 c) {
...
bool stdmath_float4x3_equal_to(const stdmath_float4x3* a, const stdmath_float4x3* b) {
	return c(*a) == c(*b);
}
bool stdmath_float4x3_not_equal_to(const stdmath_float4x3* a, const stdmath_float4x3* b) {
	return c(*a) != c(*b);
}
bool stdmath_float4x3_approximately_equal(const stdmath_float4x3* a, const stdmath_float4x3* b) {
...
stdmath_string_view stdmath_float4x3_to_string(const stdmath_float4x3* m) {
