...
STDMATH_EXPORT bool stdmath_float4x3_approximately_equal(stdmath_float4x3* a, stdmath_float4x3* b);
...
bool stdmath_float4x3_approximately_equal(stdmath_float4x3* a, stdmath_float4x3* b) {
