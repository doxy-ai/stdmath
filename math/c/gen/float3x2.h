...
STDMATH_EXPORT bool stdmath_float3x2_approximately_equal(stdmath_float3x2* a, stdmath_float3x2* b);
...
bool stdmath_float3x2_approximately_equal(stdmath_float3x2* a, stdmath_float3x2* b) {
