...
STDMATH_EXPORT bool stdmath_radian4x2_approximately_equal(const stdmath_radian4x2* a, const stdmath_radian4x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_radian4x2_to_string(const stdmath_radian4x2* m);
...
bool stdmath_radian4x2_approximately_equal(const stdmath_radian4x2* a, const stdmath_radian4x2* b) {
...
stdmath_string_view stdmath_radian4x2_to_string(const stdmath_radian4x2* m) {
