...
STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_identity_scaled(bool scale);
STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_identity();
STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_fill(bool value);

STDMATH_EXPORT size_t stdmath_bool4x2_rows(const stdmath_bool4x2* m);
STDMATH_EXPORT inline size_t stdmath_bool4x2_rows_get(const stdmath_bool4x2* m) {
	return stdmath_bool4x2_rows(m);
}
STDMATH_EXPORT size_t stdmath_bool4x2_columns(const stdmath_bool4x2* m);
STDMATH_EXPORT inline size_t stdmath_bool4x2_columns_get(const stdmath_bool4x2* m) {
	return stdmath_bool4x2_columns(m);
}
STDMATH_EXPORT size_t stdmath_bool4x2_size(const stdmath_bool4x2* m);

STDMATH_EXPORT bool stdmath_bool4x2_get_element(const stdmath_bool4x2* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_set_element(const stdmath_bool4x2* m, size_t x, size_t y, bool value);

STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_add(const stdmath_bool4x2* a, const stdmath_bool4x2* b);
STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_subtract(const stdmath_bool4x2* a, const stdmath_bool4x2* b);
STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_negate(const stdmath_bool4x2* m);
STDMATH_EXPORT stdmath_bool2x4 stdmath_bool4x2_transpose(const stdmath_bool4x2* m);

STDMATH_EXPORT stdmath_bool4x2 stdmath_bool4x2_multiply2(const stdmath_bool4x2* a, const stdmath_bool2x2* b);
STDMATH_EXPORT stdmath_bool4x3 stdmath_bool4x2_multiply3(const stdmath_bool4x2* a, const stdmath_bool2x3* b);
STDMATH_EXPORT stdmath_bool4x4 stdmath_bool4x2_multiply4(const stdmath_bool4x2* a, const stdmath_bool2x4* b);
STDMATH_EXPORT stdmath_bool2 stdmath_bool4x2_multiply(const stdmath_bool4x2* m, stdmath_bool2 v);

STDMATH_EXPORT bool stdmath_bool4x2_equal_to(const stdmath_bool4x2* a, const stdmath_bool4x2* b);
STDMATH_EXPORT bool stdmath_bool4x2_not_equal_to(const stdmath_bool4x2* a, const stdmath_bool4x2* b);
STDMATH_EXPORT bool stdmath_bool4x2_approximately_equal(const stdmath_bool4x2* a, const stdmath_bool4x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_bool4x2_to_string(const stdmath_bool4x2* m);
...
inline stdmath::bool4x2 c(stdmath_bool4x2 c) {
	return (stdmath::bool4x2&)c;
}
inline stdmath_bool4x2 c(stdmath::bool4x2 c) {
...
bool stdmath_bool4x2_equal_to(const stdmath_bool4x2* a, const stdmath_bool4x2* b) {
	return c(*a) == c(*b);
}
bool stdmath_bool4x2_not_equal_to(const stdmath_bool4x2* a, const stdmath_bool4x2* b) {
	return c(*a) != c(*b);
}
bool stdmath_bool4x2_approximately_equal(const stdmath_bool4x2* a, const stdmath_bool4x2* b) {
...
stdmath_string_view stdmath_bool4x2_to_string(const stdmath_bool4x2* m) {
