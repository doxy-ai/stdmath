...
%extend stdmath_int2x4 {
	...
	stdmath_int2x4(const stdmath_int2x4& o) {
		stdmath_int2x4 *m;
		m = (stdmath_int2x4 *) malloc(sizeof(stdmath_int2x4));
		memcpy(m, &o, sizeof(o));
		return m;
	}
	...
	bool _equal_to(stdmath_int2x4* o) {
		return stdmath_int2x4_equal_to(self, o);
	}
	bool _not_equal_to(stdmath_int2x4* o) {
		return stdmath_int2x4_not_equal_to(self, o);
	}
	bool _approximately_equal(stdmath_int2x4* o) {
		return stdmath_int2x4_approximately_equal(self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_int2x4_to_string(self);
		*str = out.data;
		*len = out.len;
	}
