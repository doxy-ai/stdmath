...
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_identity_scaled(uint8_t scale);
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_identity();
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_fill(uint8_t value);

STDMATH_EXPORT size_t stdmath_byte2x4_rows(const stdmath_byte2x4* m);
STDMATH_EXPORT inline size_t stdmath_byte2x4_rows_get(const stdmath_byte2x4* m) {
	return stdmath_byte2x4_rows(m);
}
STDMATH_EXPORT size_t stdmath_byte2x4_columns(const stdmath_byte2x4* m);
STDMATH_EXPORT inline size_t stdmath_byte2x4_columns_get(const stdmath_byte2x4* m) {
	return stdmath_byte2x4_columns(m);
}
STDMATH_EXPORT size_t stdmath_byte2x4_size(const stdmath_byte2x4* m);

STDMATH_EXPORT uint8_t stdmath_byte2x4_get_element(const stdmath_byte2x4* m, size_t x, size_t y);
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_set_element(const stdmath_byte2x4* m, size_t x, size_t y, uint8_t value);

STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_add(const stdmath_byte2x4* a, const stdmath_byte2x4* b);
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_subtract(const stdmath_byte2x4* a, const stdmath_byte2x4* b);
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_negate(const stdmath_byte2x4* m);
STDMATH_EXPORT stdmath_byte4x2 stdmath_byte2x4_transpose(const stdmath_byte2x4* m);

STDMATH_EXPORT stdmath_byte2x2 stdmath_byte2x4_multiply2(const stdmath_byte2x4* a, const stdmath_byte4x2* b);
STDMATH_EXPORT stdmath_byte2x3 stdmath_byte2x4_multiply3(const stdmath_byte2x4* a, const stdmath_byte4x3* b);
STDMATH_EXPORT stdmath_byte2x4 stdmath_byte2x4_multiply4(const stdmath_byte2x4* a, const stdmath_byte4x4* b);
STDMATH_EXPORT stdmath_byte4 stdmath_byte2x4_multiply(const stdmath_byte2x4* m, stdmath_byte4 v);

STDMATH_EXPORT bool stdmath_byte2x4_equal_to(const stdmath_byte2x4* a, const stdmath_byte2x4* b);
STDMATH_EXPORT bool stdmath_byte2x4_not_equal_to(const stdmath_byte2x4* a, const stdmath_byte2x4* b);
STDMATH_EXPORT bool stdmath_byte2x4_approximately_equal(const stdmath_byte2x4* a, const stdmath_byte2x4* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_byte2x4_to_string(const stdmath_byte2x4* m);
...
inline stdmath::byte2x4 c(stdmath_byte2x4 c) {
	return (stdmath::byte2x4&)c;
}
inline stdmath_byte2x4 c(stdmath::byte2x4 c) {
...
bool stdmath_byte2x4_equal_to(const stdmath_byte2x4* a, const stdmath_byte2x4* b) {
	return c(*a) == c(*b);
}
bool stdmath_byte2x4_not_equal_to(const stdmath_byte2x4* a, const stdmath_byte2x4* b) {
	return c(*a) != c(*b);
}
bool stdmath_byte2x4_approximately_equal(const stdmath_byte2x4* a, const stdmath_byte2x4* b) {
...
stdmath_string_view stdmath_byte2x4_to_string(const stdmath_byte2x4* m) {
