...
STDMATH_EXPORT bool stdmath_byte2x4_approximately_equal(stdmath_byte2x4* a, stdmath_byte2x4* b);
...
bool stdmath_byte2x4_approximately_equal(stdmath_byte2x4* a, stdmath_byte2x4* b) {
