...
%extend stdmath_int2x2 {
	...
	stdmath_int2x2(const stdmath_int2x2& o) {
		stdmath_int2x2 *m;
		m = (stdmath_int2x2 *) malloc(sizeof(stdmath_int2x2));
		memcpy(m, &o, sizeof(o));
		return m;
	}
	...
	bool _equal_to(stdmath_int2x2* o) {
		return stdmath_int2x2_equal_to(self, o);
	}
	bool _not_equal_to(stdmath_int2x2* o) {
		return stdmath_int2x2_not_equal_to(self, o);
	}
	bool _approximately_equal(stdmath_int2x2* o) {
		return stdmath_int2x2_approximately_equal(self, o);
	}
	...
	void _to_string(const char** str, size_t* len) {
		auto out = stdmath_int2x2_to_string(self);
		*str = out.data;
		*len = out.len;
	}
