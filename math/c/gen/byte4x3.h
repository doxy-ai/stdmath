...
STDMATH_EXPORT bool stdmath_byte4x3_approximately_equal(const stdmath_byte4x3* a, const stdmath_byte4x3* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_byte4x3_to_string(const stdmath_byte4x3* m);
...
bool stdmath_byte4x3_approximately_equal(const stdmath_byte4x3* a, const stdmath_byte4x3* b) {
...
stdmath_string_view stdmath_byte4x3_to_string(const stdmath_byte4x3* m) {
