...
STDMATH_EXPORT bool stdmath_byte3x2_approximately_equal(const stdmath_byte3x2* a, const stdmath_byte3x2* b);
...
STDMATH_EXPORT stdmath_string_view stdmath_byte3x2_to_string(const stdmath_byte3x2* m);
...
bool stdmath_byte3x2_approximately_equal(const stdmath_byte3x2* a, const stdmath_byte3x2* b) {
...
stdmath_string_view stdmath_byte3x2_to_string(const stdmath_byte3x2* m) {
