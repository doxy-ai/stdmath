...
%extend stdmath_uint1 {
	...
	bool1 _equal_to(stdmath_uint1 o) {
		return stdmath_uint1_equal_to(*self, o);
	}
	bool1 _not_equal_to(stdmath_uint1 o) {
		return stdmath_uint1_not_equal_to(*self, o);
	}
	bool1 _less_than(stdmath_uint1 o) {
		return stdmath_uint1_less_than(*self, o);
	}
	bool1 _less_than_or_equal_to(stdmath_uint1 o) {
		return stdmath_uint1_less_than_or_equal_to(*self, o);
	}
	bool1 _greater_than(stdmath_uint1 o) {
	...
	stdmath_uint1 _lerp(stdmath_uint1 o, uint t) {
	...
	bool1 _approximately_equal(stdmath_uint1 o) {
		return stdmath_uint1_approximately_equal()
	}
