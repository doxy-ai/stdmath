...
inline size_t stdmath_double3x3_rows_get(const stdmath_double3x3* m) {
	return stdmath_double3x3_rows(m);
}
size_t stdmath_double3x3_columns(const stdmath_double3x3* m);
inline size_t stdmath_double3x3_columns_get(const stdmath_double3x3* m) {
...
stdmath::double3x3 c(stdmath_double3x3 c) {
	return (stdmath::double3x3&)c;
}
stdmath_double3x3 c(stdmath::double3x3 c) {
