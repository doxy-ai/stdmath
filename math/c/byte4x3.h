...
inline size_t stdmath_byte4x3_rows_get(const stdmath_byte4x3* m) {
	return stdmath_byte4x3_rows(m);
}
size_t stdmath_byte4x3_columns(const stdmath_byte4x3* m);
inline size_t stdmath_byte4x3_columns_get(const stdmath_byte4x3* m) {
...
stdmath::byte4x3 c(stdmath_byte4x3 c) {
	return (stdmath::byte4x3&)c;
}
stdmath_byte4x3 c(stdmath::byte4x3 c) {
