...
inline size_t stdmath_uint4x4_rows_get(const stdmath_uint4x4* m) {
	return stdmath_uint4x4_rows(m);
}
size_t stdmath_uint4x4_columns(const stdmath_uint4x4* m);
inline size_t stdmath_uint4x4_columns_get(const stdmath_uint4x4* m) {
...
stdmath::uint4x4 c(stdmath_uint4x4 c) {
	return (stdmath::uint4x4&)c;
}
stdmath_uint4x4 c(stdmath::uint4x4 c) {
