...
inline size_t stdmath_uint3x2_rows_get(const stdmath_uint3x2* m) {
	return stdmath_uint3x2_rows(m);
}
size_t stdmath_uint3x2_columns(const stdmath_uint3x2* m);
inline size_t stdmath_uint3x2_columns_get(const stdmath_uint3x2* m) {
...
stdmath::uint3x2 c(stdmath_uint3x2 c) {
	return (stdmath::uint3x2&)c;
}
stdmath_uint3x2 c(stdmath::uint3x2 c) {
