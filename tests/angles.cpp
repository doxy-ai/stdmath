...
TEST_CASE("angles") {
	// rad2deg and deg2rad
	std::math::stl::float32_t float_val = 1.0f;
	CHECK(std::math::approximately_equal(std::math::rad2deg<std::math::stl::float32_t> * std::math::PI, 180.0f, .001));
	CHECK(std::math::approximately_equal(std::math::deg2rad<std::math::stl::float32_t> * 180.0f, std::math::PI));
