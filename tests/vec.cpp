...
TEST_CASE("vec<float, 2>") {
	...
	CHECK(std::math::approximately_equal(normalized_vec_from_swizzle2.x, 0.624695));
	CHECK(std::math::approximately_equal(normalized_vec_from_swizzle2.y, 0.780869));
}
...
TEST_CASE("vec<float, 3>") {
	...
	CHECK(std::math::approximately_equal(normalized_vec_from_swizzle3.x, 0.517892));
	CHECK(std::math::approximately_equal(normalized_vec_from_swizzle3.y, 0.575435));
	CHECK(std::math::approximately_equal(normalized_vec_from_swizzle3.z, 0.632979));
}
...
TEST_CASE("vec<float, 4>") {
	...
	CHECK(std::math::approximately_equal(normalized_vec_from_swizzle4.x, 0.537579));
	CHECK(stdmath::approximately_equal(normalized_vec_from_swizzle4.y, 0.460782));
	CHECK(stdmath::approximately_equal(normalized_vec_from_swizzle4.z, 0.486381));
	CHECK(stdmath::approximately_equal(normalized_vec_from_swizzle4.w, 0.51198));
